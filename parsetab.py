...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','test.py',44),
  ('expr -> expr MINUS expr','expr',3,'p_sub','test.py',48),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','test.py',52),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','test.py',56),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','test.py',57),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','test.py',68),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','test.py',72),
]
